...
class Database(object):
    ...
    def get_book_by_id(self, book_id):
        ...
        cursor.execute("SELECT book_id, book_title, annotation, sequence FROM book WHERE book_id = ?", (book_id,))
    ...
    def get_books_by_author(self, author_id):
        return [Book(1, "book title", [Author(author_id, "first name", "second name")], [], None, None)]
